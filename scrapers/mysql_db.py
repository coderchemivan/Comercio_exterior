...
class MysqlDB():
    ...
    def insertar_registro(self,tabla,diccionario):
        ...
        if tabla =='world_trade_':
            insertar_registro = "INSERT INTO world_trade_ (reporter_country,year,section,SA_2,SA_4, imp_exp,partner_code,tradevalue,tradequantity,quantity_unit,netweight,grossweight) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
            ...
            insertar_registro = "INSERT INTO world_trade (reporter_country,year,period,section,SA_2,SA_4, imp_exp,partner_code,tradevalue,tradequantity,altquantity,netweight,grossweight) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
            cur.execute(insertar_registro, (diccionario['reporter_country'],
                                            diccionario['year'],
                                            diccionario['period'],
                                            diccionario['section'],
